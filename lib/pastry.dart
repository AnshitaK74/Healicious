...
class _pastryState extends State<pastry> {
  ...
  final List<String> impacts = [
    "High in refined sugars : spikes insulin levels",
    "Increases insulin resistance : worsens hormonal imbalance",
    "High in saturated & trans fats : promotes inflammation",
    "Low in fiber : poor blood sugar control and digestion",
    "High-calorie : contributes to weight gain",
  ];
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text('45 g', style: TextStyle(fontSize: width * 0.035))),
                  ]),
                  DataRow(cells: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text('7–10 g', style: TextStyle(fontSize: width * 0.035))),
                  ]),
                ],
              ),
            ),
