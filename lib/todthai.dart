...
class _todMunGoongState extends State<todMunGoong> {
  ...
  final List<String> impacts = [
    "High in unhealthy fats: Deep-frying increases trans fats, which can worsen inflammation in PCOS.",
    "High in refined carbs: The batter is often made with refined flour, which can spike blood sugar levels.",
    "High in calories: Fried shrimp cakes are calorie-dense and can contribute to weight gain and worsen insulin resistance.",
    "Low in fiber: These shrimp cakes are low in fiber, which is important for blood sugar regulation.",
    "Increased insulin resistance: Consuming fried foods can worsen insulin sensitivity, a common issue in PCOS."
  ];
