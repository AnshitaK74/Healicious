...
import 'package:recepie_app/day2thai.dart';

class day1thai extends StatelessWidget {
  const day1thai({super.key});
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/shrimp.jpeg', // Junk food
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/img_2.png', // Healthy swap
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => day2thai()),
                    );
                  },
