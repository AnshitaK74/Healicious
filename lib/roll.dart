...
class EggRoll extends StatefulWidget {
  const EggRoll({super.key});

  @override
  State<EggRoll> createState() => _EggRollState();
}

class _EggRollState extends State<EggRoll> {
  final ScrollController _scrollController = ScrollController();

  final List<String> impacts = [
    "High in calories: Deep-fried and filled with fatty meats or oil-heavy vegetables.",
    "Trans fats: Often cooked in reused or partially hydrogenated oils.",
    "Hard to digest: The fried outer shell can irritate sensitive stomachs.",
  ];
