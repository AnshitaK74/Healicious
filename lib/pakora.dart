...
class _PakoraState extends State<Pakora> {
  ...
  final List<String> impacts = [
    "Too oily: They soak lots of oil and it is very high in calories which leads to more stored fat.",
    "Easy to overeat: Tasty to eat which leads to overeating and in turn weight gain.",
    "Genetics: Some genetically gain weight easily eating them can lead to hormonal imbalance and extra fat in body",
  ];
