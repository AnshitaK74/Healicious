...
class dairythai extends StatefulWidget {
  const dairythai({super.key});

  @override
  State<dairythai> createState() => _dairythaiState();
}

class _dairythaiState extends State<dairythai> {
  @override
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => chayen9()),
                        );
                      },
                      child: Card(
                        elevation: 4,
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => tubtimgrob23()),
                        );
                      },
                      child: Card(
                        elevation: 4,
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => thaicurry5()),
                        );
                      },
                      child: Card(
                        elevation: 4,
