...
import 'package:recepie_app/dayindian.dart';

class day4indian extends StatelessWidget {
  const day4indian({super.key});
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/p.jpeg', // Junk food
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/q.jpeg', // Healthy swap
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => day5indian()),
                    );
                  },
