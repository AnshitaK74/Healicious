...
class Pizza100 extends StatefulWidget {
  const Pizza100({super.key});

  @override
  State<Pizza100> createState() => _Pizza100State();
}

class _Pizza100State extends State<Pizza100> {
  final ScrollController _scrollController = ScrollController();

  final List<String> impacts = [
    "Refined White Flour: Pizza dough is typically made with refined white flour, leading to rapid blood sugar spikes.",
    "High Glycemic Index: The refined carbs in pizza crust are quickly digested and absorbed, causing a sharp increase in glucose levels.",
    "Insulin Resistance Risk: Regular consumption of refined carbs, especially in large portions, may contribute to insulin resistance over time.",
  ];
