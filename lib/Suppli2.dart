...
class _suppliState extends State<suppli> {
  ...
  final List<String> impacts = [
    "Deep-fried coating introduces unhealthy fats that may inflame the gut lining.",
    "High in refined carbs from white rice and breadcrumbs, which can feed harmful gut bacteria.",
    "Often contains cheese and processed meats, which are hard to digest and can disrupt gut flora."
  ];
