...
class WednesdayDiabetesIndianDishes extends StatefulWidget {
  const WednesdayDiabetesIndianDishes({super.key});

  @override
  State<WednesdayDiabetesIndianDishes> createState() => _WednesdayDiabetesIndianDishesState();
}

class _WednesdayDiabetesIndianDishesState extends State<WednesdayDiabetesIndianDishes> {
                            ...
                            children: [
                              Card(
                                ...
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: Image.asset(
                                    'assets17/images17/upma.jpeg', height: 200,
                                    width: 150,
                                    fit: BoxFit.cover,
                                  ),
                                ),
