...
import 'package:recepie_app/day6.dart';


class day5japan extends StatelessWidget {
  @override
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/d.jpeg', // Unhealthy food
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
                    ...
                    children: [
                      Card(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Image.asset(
                            'assets18/images18/e.jpeg', // Healthy swap
                            width: imageSize,
                            height: imageSize,
                            fit: BoxFit.cover,
                          ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => day6japan()),
                    );
                  },
