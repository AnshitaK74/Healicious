...
class _cocacolaState extends State<cocacola> {
  ...
  final List<String> impacts = [
    "Acid Reflux/GERD: High acidity can relax the lower esophageal sphincter, leading to acid reflux.",
    "Irritable Bowel Syndrome (IBS): Carbonation and artificial additives may trigger IBS symptoms.",
    "Gut Microbiome Imbalance: High sugar content can disrupt healthy gut bacteria and promote harmful microbes.",
  ];
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text('45 mg', style: TextStyle(fontSize: width * 0.035))),
                  ]),
                  DataRow(cells: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Text('34 mg', style: TextStyle(fontSize: width * 0.035))),
                  ]),
                ],
              ),
            ),
